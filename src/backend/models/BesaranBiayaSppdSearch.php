...
/**
 * BesaranBiayaSppdSearch represents the model behind the search form of `common\models\BesaranBiayaSppdExt`.
 */
class BesaranBiayaSppdSearch extends BesaranBiayaSppdExt
{
    ...
    {
        return [
            [['id', 'jabatan_daerah_id', 'jabatan_struktural_id', 'jabatan_fungsional_id', 'kategori_wilayah', 'jenis_biaya_sppd_id', 'status', 'produk_hukum_id', 'created_at', 'created_by', 'updated_at', 'updated_by'], 'integer'],
