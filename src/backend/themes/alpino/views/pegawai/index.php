...
<div class="pegawai-index">
    <div class="card">
        <div class="header">
            <h2><strong>Daftar</strong> Pegawai<small>*Isian yang ada di atas setiap kolom dalam daftar adalah isian pencarian</small> </h2>

            <ul class="header-dropdown">
                <li class="dropdown">
                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="zmdi zmdi-more"></i> </a>
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li><?php echo Html::a('Tambah Pegawai', array_merge(['create'], $get)) ?></li>
                        <li><?php echo Html::a('Bersihkan Pencarian', ['/pegawai']) ?></li>
                    </ul>
                </li>
            </ul>
        </div>
                    ...
                    [
                        ...
                        'buttons' => [
                            'generate-user' => function($url, $model) {
                                ...
                                if ($model->user_id && $model->user->can(\common\models\UserExt::ROLE_ASN)) {
                                    return Html::a(
                                                    Html::tag('i', '', ['class' => 'zmdi zmdi-account'])
                                ...
                                return Html::a(Html::tag('i', '', ['class' => 'zmdi zmdi-account']), $url
                                            ...
                                            'data' => [
                                                'method' => 'post',
                                                'pjax' => 0,
                                                'confirm' => 'Yakin akan membuatkan user untuk pegawai ini?'
                                            ],
                                ]);
                            }
                        ]
