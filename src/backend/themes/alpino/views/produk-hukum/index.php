...
/* @var $searchModel backend\models\ProdukHukumSearch */
...
<div class="produk-hukum-index">
    <div class="card">
        <div class="header">
            <h2><strong>Daftar</strong> Produk Hukum<small>*Isian yang ada di atas setiap kolom dalam daftar adalah isian pencarian</small> </h2>

            <ul class="header-dropdown">
                <li class="dropdown">
                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="zmdi zmdi-more"></i> </a>
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li><?php echo Html::a('Tambah Produk Hukum', ['create']) ?></li>
                    </ul>
                </li>
            </ul>
        </div>
