...
/**
 * JabatanDaerahSearch represents the model behind the search form of `common\models\JabatanDaerahExt`.
 */
class JabatanDaerahSearch extends JabatanDaerahExt
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['nama', 'nama_2', 'tingkat_sppd', 'keterangan'], 'safe'],
        ];
    }
